...
def main():
    ...
    for name in ('test_general_execution.py','test_interaction_admission.py','test_interaction_receipts.py','test_general_worker_entry.py','test_primary_sessions.py','test_mission_controls.py','test_mission_session_authority.py','test_auxiliary_caller_admission.py','test_human_gate_resume.py'):
