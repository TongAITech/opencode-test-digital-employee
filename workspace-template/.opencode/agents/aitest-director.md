...
- G4 real execution and test-goal convergence are available through `aitest_g4_director` plus Router-bound `aitest_executor` actions. G1-G5 engineering is CLOSED/FROZEN at canonical main 58e5e1259cd26846b31ea21a8a87df0bcf071edc. G5 defect flow uses its governed Diagnosis tools. G6 continuous learning remains HOLD. Product version 1.12.0 is the V1.9.4 recovery delivery; bank validation remains separate.
